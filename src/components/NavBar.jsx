...
const NavBar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-yellow-100 shadow-md">
      <div className="flex justify-between items-center p-5 text-yellow-900 dark:text-yellow-700 relative">
        {/* Logo */}
        ...
        <div
          className={`fixed top-16 left-0 w-full flex flex-col items-start bg-yellow-100
